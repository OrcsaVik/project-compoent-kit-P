...
package com.github.framework.log.core;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.date.SystemClock;
import com.alibaba.fastjson2.JSON;
import com.github.framework.log.annotation.ILog;
...
/**
 * @author Vik
 * @date 2025-09-03 17:09
 * @description
 */
@Aspect
public class ILogPrintAspect {

    @Pointcut("@annotation(com.github.framework.log.annotation.ILog) || @within(com.github.framework.log.annotation.ILog)")
    public void iLogPrintAspect() {
    }

    @Around("iLogPrintAspect()")
